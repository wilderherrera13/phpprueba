...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div class="container">
        ...
        <h6 class="text-secondary"> REPORTE DE ARCHIVOS </h6>
		<table class="table table-striped table-bordered">
		<tr>
			<th class="text-secondary">Id del archivo</th>
			<th class="text-secondary">Nombre de archivo</th>
			<th class="text-secondary">Extension</th>
		</tr>
		
			<?php
				$results=$db_conection->query("select * from soapserviceresults.archivo inner join soapserviceresults.extension on soapserviceresults.archivo.id_de_archivo = soapserviceresults.extension.FK_ID_ARCHIVO_ID_ARCHIVO where 1");
